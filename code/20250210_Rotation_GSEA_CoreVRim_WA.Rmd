...
BiocManager::install(c("clusterProfiler", "org.Hs.eg.db", "org.Mm.eg.db", "org.Rn.eg.db")) # For human genes
...
library(org.Hs.eg.db)  # Replace with your organism-specific database if needed
library(DOSE)  # Optional, for additional visualization
library(tidyr)
library(readxl)
library(here)
library(gitcreds)
